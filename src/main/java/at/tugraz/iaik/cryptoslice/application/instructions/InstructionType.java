...
public enum InstructionType {
  ...
  PUT,
  APUT,
  MATH_1, // unary operations or binary operations with only 1 target and 1 source reg
  MATH_2, // binary operations with 1 target and 2 sources
  MATH_2C, // binary operations with 1 target, 1 source and 1 constant instead of register
  CONST,
  GET,
  AGET,
  MOVE,
