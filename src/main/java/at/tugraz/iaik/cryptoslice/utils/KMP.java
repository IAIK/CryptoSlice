...
public class KMP {
  ...
  /**
   * Search the data byte array for the first occurrence of the byte array pattern beginning at offset.
   * Use '*' as a wildcard for any amount of arbitrary bytes. A trailing wildcard will be ignored.
   */
  public static int indexOf(byte[] data, int offset, byte[] pattern, boolean ignoreCase, boolean wildcard) {
